    ...
    <div className="min-h-screen flex" style={{ background: 'var(--bg)' }}>
      ...
      >
        ...
        <div className="space-y-8">
          <div className="font-code text-sm space-y-2 p-6 rounded-xl"
               style={{ background: 'var(--bg-2)', border: '1px solid var(--border)', color: 'var(--accent)' }}>
            <div><span style={{ color: 'var(--text-muted)' }}>// Your progress today</span></div>
            <div>totalSolved: <span style={{ color: 'var(--medium)' }}>342</span>,</div>
            <div>streak: <span style={{ color: 'var(--medium)' }}>7</span> days 🔥,</div>
            <div>todayTarget: <span style={{ color: 'var(--easy)' }}>"2 mediums"</span></div>
          </div>

          <div>
            <h2 className="font-display font-black text-3xl mb-3" style={{ color: 'var(--text-primary)' }}>
              Track. Sync. Improve.
            </h2>
            <p className="text-sm leading-relaxed" style={{ color: 'var(--text-secondary)' }}>
              Your LeetCode grind deserves a proper dashboard. Sign in to see your stats, problem sheets, and AI-powered study insights.
            </p>
          </div>
        </div>
        ...
        >
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center">
              <span className="px-3 text-xs" style={{ background: 'var(--bg)', color: 'var(--text-muted)' }}>
                or demo as
              </span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            {[['Student', 'student@demo.com'], ['Teacher', 'teacher@demo.com']].map(([role, email]) => (
              <motion.button
                key={role}
                whileHover={{ scale: 1.03 }}
                whileTap={{ scale: 0.97 }}
                onClick={() => setForm({ email, password: 'demo1234' })}
                className="py-2.5 rounded-xl text-xs font-code font-medium transition-all"
